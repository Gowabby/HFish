...
(function() {
  ...
  CodeMirror.defineMIME("text/x-cassandra", {
    ...
    builtin: set("ascii bigint blob boolean counter decimal double float frozen inet int list map res text timestamp timeuuid tuple uuid varchar varint"),
